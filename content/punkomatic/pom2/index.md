...
#### Chucks Nation — Open Wound

Extra 1

{% punkomatic_song(slug="open-wound") %}
...
#### Bored Again — From The Heart

Extra 3

{% punkomatic_song(slug="from-the-heart") %}
...
#### Evil-Dog — Shove Yourself Up Your Ass!

Extra 4

{% punkomatic_song(slug="shove-yourself-up-your-ass") %}
...
#### The Screaming Pelicans — Valedico

Garage 1

{% punkomatic_song(slug="valedico") %}
...
#### Status Quo Exile — No More Dead

Garage 2

{% punkomatic_song(slug="no-more-dead") %}
...
#### Toxic Infectors — The Avenger

Garage 3

{% punkomatic_song(slug="the-avenger") %}
...
#### Lemonade Frenzy — Pick It Up!

Garage 5

{% punkomatic_song(slug="pick-it-up") %}
...
#### Bad Ear — Rolling With The Punches

Bar 1

{% punkomatic_song(slug="rolling-with-the-punches") %}
...
#### Killed On Impact — A Reason To Forgive

Bar 4

{% punkomatic_song(slug="a-reason-to-forgive") %}
...
#### The Klaxon Wail — Shittin Out A Helicopter

Bar 5

{% punkomatic_song(slug="shittin-out-a-helicopter") %}
...
#### Elicium Punks — Stand and Fight

Concert Hall 1

{% punkomatic_song(slug="stand-and-fight") %}
...
#### Empty Agony — Unbearable Existance

Concert Hall 2

{% punkomatic_song(slug="unbearable-existance") %}
...
#### Chucks Nation — Now Is Here

Concert Hall 3

{% punkomatic_song(slug="now-is-here") %}
...
#### The Nuclear Rebellion — Marching To War

Concert Hall 4

{% punkomatic_song(slug="marching-to-war") %}
...
#### Static Burst — We Rise From Your Demise

Concert Hall 5

{% punkomatic_song(slug="we-rise-from-your-demise") %}
...
#### The Tribal Trooboos — No Threats Allowed

Theater 1

{% punkomatic_song(slug="no-threats-allowed") %}
...
#### East of Here — The Crusaders

Theater 2

{% punkomatic_song(slug="the-crusaders") %}
...
#### The Necromancers — As Flames Light The Sky

Theater 3

{% punkomatic_song(slug="as-flames-light-the-sky") %}
...
#### The Dudes — A Doped Up Dream

Theater 4

{% punkomatic_song(slug="a-doped-up-dream") %}
...
#### Bloody Herring — Death Insurance

Theater 5

{% punkomatic_song(slug="death-insurance") %}
...
#### Jurassic Octopus — Empty Octopus Glasses

Stadium 1

{% punkomatic_song(slug="empty-octopus-glasses") %}
...
#### Fenix Revolution — Going Nowhere

Stadium 3

{% punkomatic_song(slug="going-nowhere") %}
...
#### The White Divinities — A Post-War Generation

Stadium 4

{% punkomatic_song(slug="a-post-war-generation") %}
...
#### Solanum Slaves — Not So Lethal Buns

Stadium 5

{% punkomatic_song(slug="not-so-lethal-buns") %}
...
#### Galaxy Slayers — Black Hole

Park 1

{% punkomatic_song(slug="black-hole") %}
...
#### The Afro Anarchists — The Scumdogs Return

Park 2

{% punkomatic_song(slug="the-scumdogs-return") %}
...
#### Those Who Died — We Will Grind You

Park 3

{% punkomatic_song(slug="we-will-grind-you") %}
...
#### Impending Shadows — Tornadic

Park 4

{% punkomatic_song(slug="tornadic") %}
...
#### The Dutchies — On Your Knees!

Park 5

{% punkomatic_song(slug="on-your-knees") %}
